                ...
                $('#finestra').dialog({
                    ...
                    buttons: {
                        "Aggiungi": function(){
                            ...
                            //$('<p>'+valore+'   :'+contenuto+'</p>').appendTo('#box');
                            //$('#box').html("<b>numero: "+valorOpzioni+"</b>");
                             //$('#box').html("Ciao mondo");
                            //$("#box").append(" write less, do more  ");                           
                             //var valorOpzioni = $("input[type=hidden][name=numerOpzioni]").val();                           
    ...
    <body>
        ...
        <!--<form name="f1" method="POST" action="/CoHome-war/MainServlet">
            ...
            <!--<table id="tabella"
                ...
                <tr>
                    <td><button id="openFinestra" class="btn btn-warning" >Inserimento Opzioni</button></td>
                </tr> 
            </table>!-->
      ...
      <!--  
      <form name="fileUpload" method="post" action="/CoHome-war/MainServlet" enctype="multipart/form-data">
         <label>File da inviare al server</label>
         <input type="file" name="nomeFile" />
         <input type="hidden" name="op" value="uploadFoto">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="foto">
                    ...
                    <!--<form name="fileUpload" method="post" action="/CoHome-war/MainServlet" enctype="multipart/form-data">
                        <label>File da inviare al server</label>
                        <input type="file" name="nomeFile" />
                        <input type="hidden" name="op" value="uploadFoto2">
                        <input type="submit" value="invio"/>
                    </form>!-->
                </div>
